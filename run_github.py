...
function filterBtn(page,type,val,label){let active=STATE[page][type].has(val);return '<button class="filterBtn '+(active?'active':'')+'" onclick="toggle(STATE.'+page+'.'+type+',\''+esc(val)+'\');rerenderActive()">'+esc(label||val)+'</button>'}
